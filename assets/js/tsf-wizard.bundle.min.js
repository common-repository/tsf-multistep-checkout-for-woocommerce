...
(function(factory) {
    ...
    var _this, _navPos, _stepEff, _notShown, _allCount, _top, _left, _notShownField, _avgHeight, _shownCount, _notShownCount, _windowWidth, _stepStyle, _width, _height, _currIndex, _from, _to, _element, _disableSteps, _stepDisable, activeIndex, _content, _parent, _oldIndex, _return, _newIndex, _id, _step_effect, _count, _finish, _first, _btnPrev, _btnNext, _btnFinish, _index, _dataType;
    var _fistVal = false,
        _isValid = true;
    ...
    tsfWizard.prototype = {
        ...
        loadScript: function() {
            if (_this.config.navPosition == 'top' || _this.config.navPosition == 'bottom') {
                // _width = _this.$elem.find('.tsf-content').width();
                // _this.$elem.find('.tsf-nav').css('width', (_width));
                _width = 0;
        ...
        wizardNavStepClick: function(_element, from) {
            ...
            if (!_fistVal) {
                ...
                // if (_oldIndex < _element.index() && from == 'nav-step') {
                //     return false;
                // }
            ...
            _parent.find('.tsf-step').removeClass('active').removeClass(_step_effect);
            _parent.find('.' + _id).addClass('active').addClass(_step_effect);
            ...
            if (_this.config.manySteps) {
                ...
                if (typeof _element.position() != "undefined") {
                    ...
                    if (_this.config.navPosition == 'top' || _this.config.navPosition == 'bottom') {
                        ...
                        _windowWidth = _this.$elem.find('.tsf-content').width();
    ...
    $.fn.tsfWizard = function(options) {
        ...
        this.onBeforeNextButtonClick = function(func) {
            _tsfWizard.config.onBeforeNextButtonClick = func;
        }
